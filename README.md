...
## Grayscale Image Example(test_images.cpp)
...
This folder contains the models and .exe file for landmark detection application with this Mini-caffe. Details are explained in the README.md of this folder.
